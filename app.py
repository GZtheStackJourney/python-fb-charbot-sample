                ...
                if messaging_event.get("postback"):  # user clicked/tapped "postback" button in earlier message
                    ...
                    if messaging_event['postback'].get('payload'):
                        ...
                        if payload_text == "get started":
                        	...
                        	GenericElement("Robots in virtual space", "The rise of Artificial Intelligence", "https://en.wikipedia.org/wiki/Artificial_intelligence", "https://media.istockphoto.com/photos/irobot-touch-picture-id543190650", [ActionButton(ButtonType.WEB_URL, "Learn More", "https://en.wikipedia.org/wiki/Artificial_intelligence")]), 
                        	GenericElement("Machine Learning", "The learning of Machine", "https://www.youtube.com/watch?v=Cr6VqTRO1v0&vl=en", "https://cdn-images-1.medium.com/max/1600/1*3CXBOKNql4qS-lRyHT3pqw.png", [ActionButton(ButtonType.WEB_URL, "Learn ML now", "https://www.youtube.com/watch?v=Cr6VqTRO1v0&vl=en")])]
